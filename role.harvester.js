module.exports = {
    ...
    run: function (creep) {
        ...
        // 3. Gather (Harvest)
            ...
            // For simple harvester, just Source for now.
            // But let's check if there are any dropped resources nearby to pick up? 
            // Keep it simple for now to avoid logic loops.
